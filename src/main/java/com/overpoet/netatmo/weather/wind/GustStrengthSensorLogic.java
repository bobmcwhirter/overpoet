...
public class GustStrengthSensorLogic extends BaseNetatamoSensorLogic<Integer> {
    ...
    public static Sensor<?> of(Key key, LogicRegistry registry) {
        return new IntegerSensor(key, IntegerMetadata.DEFAULT, registry.register(new GustStrengthSensorLogic()));
    }
