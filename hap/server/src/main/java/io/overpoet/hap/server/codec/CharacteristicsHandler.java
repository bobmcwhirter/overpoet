...
public class CharacteristicsHandler extends ChannelInboundHandlerAdapter {
    public CharacteristicsHandler(ServerAccessoryDatabase db) {
        this.db = db;
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ByteBuf content = httpMsg.content();
        ...
        if ( httpMsg.method() == HttpMethod.PUT ) {
        ...
        } else if ( httpMsg.method() == HttpMethod.GET ) {
            ...
            System.err.println( "sending get /char of " + content.toString(Charset.forName("UTF-8")));
