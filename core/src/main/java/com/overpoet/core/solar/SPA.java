...
import com.overpoet.core.chrono.JulianDate;
...
public final class SPA {
     ...
     */
    public static ZonedDateTime[] calculateSunriseTransitSet(final ZonedDateTime day,
    ...
    private static ZonedDateTime addFractionOfDay(ZonedDateTime day, final double fraction) {
        day = day.with(LocalTime.MIDNIGHT);
        final int offset = 0;
        ...
        day = day.plusSeconds( addMs / 1000 );
...
//
        //return utcCalendar;
        return day.with(LocalTime.MIDNIGHT);
    }
